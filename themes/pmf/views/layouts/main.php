...
<head>
    ...
    <script type="text/javascript"
            src="<?php echo Yii::app()->request->baseUrl; ?>/highslide/highslide-with-gallery.js"></script>
...
<div class="page-container" id="page">
    <div id="header">
        ...
        <div id="social">
            ...
            <div id="uLogin" x-ulogin-params="display=buttons;fields=first_name,last_name,email;redirect_uri=<?php echo Yii::app()->createAbsoluteUrl('/ulogin/login'); ?>">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/img/facebook.png" alt="Facebook" x-ulogin-button="facebook"/>
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/img/vkontakte.png" alt="В контакте" x-ulogin-button="vkontakte"/>
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/img/odnoklassniki.png" alt="Одноклассники" x-ulogin-button="odnoklassniki"/>
            </div>
            <?php } else { ?>
